...
public class Ingrediente {
    ...
    private double stockMinimo;    // nivel mínimo para alertas
    ...
    /**
     * GRASP Information Expert: el Ingrediente conoce su cantidad y
     * es responsable de actualizarla.
     */
     ...
     * Usado en la integración cocina-inventario.
     */
    public void descontarStock(double cantidadUso) {
        ...
        if (this.cantidad < cantidadUso) {
            throw new IllegalStateException(
                    "Stock insuficiente para '" + nombre + "'. Disponible: " + cantidad + " " + unidad);
        }
